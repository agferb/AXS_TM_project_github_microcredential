...
#### Make temporary commits to avoid `merge` problems

It is possible to temporarily store tracked and modified files before moving in between branches or merging, avoiding these modifications to be pushed.
